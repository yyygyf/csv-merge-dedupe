...
import { compareReport } from './compare-report.mjs';
...
async function main() {
  ...
  const changeReport = compareReport(mergedCsv,later,['订单号']);
  ...
  const files = {'source-a.csv':first,'source-b.csv':second,'later.csv':later,
    ...
    'changes.html':changeReport.html,
    'README.md':notes.replace('- changes.json：逐字段变更记录。', '- changes.json：逐字段变更记录。\n- changes.html：双击打开的中文变化报告，展示同样的新增、删除和字段修改。')};
